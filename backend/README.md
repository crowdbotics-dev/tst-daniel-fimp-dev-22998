...
## Project Structure
    ...
    ├── tst_daniel_fimp_dev_22998  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_fimp_dev_22998`
...
2. Clone this repo and `cd tst_daniel_fimp_dev_22998`
